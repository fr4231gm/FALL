...
public class ProclaimServiceTest extends AbstractTest {
	...
	//Crear una proclama con texto vac�o		
	...
	public void createProclaimTestDriver() {
		final Object testingData[][] = {
			...
			// TEST POSITIVO: Crear una proclama con texto no vac�o
			{
				"chapter1", "text", null
			},

			// TEST NEGATIVO: Crear una proclama con texto vac�o
			{
			...
			{
				"chapter1",
				"Lorem ipsum dolor sit amet, consectetur adipiscing elit. In suscipit mauris eu fermentum lobortis. Maecenas aliquam purus id tellus commodo pulvinar. Fusce ultrices quam ipsum, in ullamcorper sapien suscipit vitae. Phasellus accumsan odio et posuere. Me pas�",
	...
	public void editProclaimTestDriver() {
		final Object testingData[][] = {
			...
			// TEST POSITIVO: Editar una proclama m�a con momento nulo
			{
	...
	public void publishProclaimTestDriver() {
		final Object testingData[][] = {
			...
			// TEST POSITIVO: Publicar una proclama m�a con momento nulo
			{
			...
			// TEST NEGATIVO: Publicar una proclama m�a con momento no nulo
			{
	...
	//Borrar una proclama m�a con momento no nulo
	...
	public void deleteProclaimTestDriver() {
		final Object testingData[][] = {
			...
			// TEST POSITIVO: Borrar una proclama m�a con momento nulo
			{
				"chapter2", super.getEntityId("proclaim2"), null
			},
			...
			// TEST NEGATIVO: Borrar una proclama m�a con momento no nulo
			{
				"chapter1", super.getEntityId("proclaim1"), IllegalArgumentException.class
			}
		};
