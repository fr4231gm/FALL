...
public class MiscellaneousRecordServiceTest extends AbstractTest{
	...
	//Intentar crear un miscellaneous record sin descripci�n
	...
	public void CreateEditMiscellaneousTestDriver() {
		...
		final Object testingData[][] = {
				...
				//TESTS NEGATIVOS:
				{"brotherhood1","title", null,  ConstraintViolationException.class}, //Intentar crear un miscellaneous record sin descripci�n
