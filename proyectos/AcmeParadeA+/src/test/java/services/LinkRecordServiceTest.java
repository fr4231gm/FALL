...
public class LinkRecordServiceTest extends AbstractTest{
	...
	//Intentar crear un link record sin descripci�n
	...
	//Crear un link record con codigo malicioso en el t�tulo
	...
	public void CreateEditLinkTestDriver() {
		...
		final Object testingData[][] = {
				...
				//TESTS NEGATIVOS:
				{"brotherhood1","title", null, "brotherhood2",  ConstraintViolationException.class}, //Intentar crear un link record sin descripci�n
				...
				{"brotherhood1","<script>alert('piu')</script>","description", "brotherhood2", ConstraintViolationException.class}, //Crear un link record con codigo malicioso en el t�tulo
			
				{"brotherhood1","title","<p>alert('descripci�n maliciosa')</p>", "brotherhood2", ConstraintViolationException.class} //Crear un link record con codigo malicioso en la descripcion
		};
