...
public class PeriodRecordServiceTest extends AbstractTest{
	...
	//Intentar crear un period record sin descripci�n
	...
	//Intentar crear un period con una url no v�lida
	//Intentar crear un period record sin haber creado antes una history
	//Intentar crear un period record si soy un admin
	//Intentar crear un period record con a�o de inicio mayor que a�o de fin
	//Intentar crear un period record con a�o de inicio anterior al establishment date	
	...
	public void CreateEditPeriodTestDriver() {
		...
		final Object testingData[][] = {
				...
				//TESTS NEGATIVOS:
				{"brotherhood1","title", null, "", 2019, 2020,  ConstraintViolationException.class}, //Intentar crear un period record sin descripci�n
				...
				{"brotherhood1", "title", "description", "HoLaSoYuNaURLquenovaleparanada", 2019, 2020, IllegalArgumentException.class}, //Intentar crear un period con una url no v�lida
				...
				{"brotherhood1","title", "description", "", 2020, 2019, IllegalArgumentException.class}, //Intentar crear un period record con a�o de inicio mayor que a�o de fin
				
				{"brotherhood1","title", "description", "", 1200, 2020, IllegalArgumentException.class} //Intentar crear un period record con a�o de inicio anterior al establishment date
		};
