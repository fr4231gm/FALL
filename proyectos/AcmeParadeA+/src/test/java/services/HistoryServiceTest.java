...
public class HistoryServiceTest extends AbstractTest {
	...
	//Intentar crear un History cuyo inception Record no tenga descripci�n
	//Intentar crear un History cuyo inception Record no tenga t�tulo
	...
	public void CreateEditHistoryTestDriver() {
		...
		final Object testingData[][] = {
				...
				{ "brotherhood3", "title", "", "", ConstraintViolationException.class },		// Intentar 
																							//Crear un History
				 																			// cuyo inception Record no tenga descripci�n
				
				
				{ "brotherhood3", "", "description", "", ConstraintViolationException.class } 	// Intentar 
																	 					  	//Crear un History
																	 					  	// cuyo inception Record no tenga t�tulo
