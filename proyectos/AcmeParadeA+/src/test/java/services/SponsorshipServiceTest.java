...
public class SponsorshipServiceTest extends AbstractTest {
	...
	//intento editar un sponsorship con url inv�lida
	...
	public void editSponsorshipTestDrive() {
		final Object testingData[][] = {
			...
			// Test negativo: intento editar un sponsorship que no es m�o
			{
				"sponsor2", super.getEntityId("sponsorship1"), super.getEntityId("creditCard1"), "https://www.Banner.es", "http://www.Banner.es", IllegalArgumentException.class
			},

			// Test negativo: intento editar un sponsorship con url inv�lida
			{
