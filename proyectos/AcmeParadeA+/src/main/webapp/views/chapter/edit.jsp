...
<form:form 
	...
	<acme:input code="chapter.name" path="name" placeholder="José"/>
	<br />

	<acme:input code="chapter.middle.name" path="middleName" placeholder="Emilio"/>
	<br />

	<acme:input code="chapter.surname" path="surname" placeholder="González Gutiérrez"/>
	<br />
	...
	<acme:input code="chapter.address" path="address" placeholder="Calle Desengaño,21"/>
	<br />
