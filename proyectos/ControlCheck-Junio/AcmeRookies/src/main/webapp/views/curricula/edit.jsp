...
<form:form action="curricula/rookie/edit.do" modelAttribute="personalData" id="personalData"
onsubmit='return phoneValidation("${phoneConfirmationPrefix}", "${phoneConfirmationSuffix}")'>>
	...
	<form:input path="statement" placeholder="Al oeste Filadelfia crecía y vive" />
