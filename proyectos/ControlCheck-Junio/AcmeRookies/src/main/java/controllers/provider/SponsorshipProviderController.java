...
public class SponsorshipProviderController extends AbstractController{
	...
	public ModelAndView list(){
		ModelAndView res;
		Collection<Sponsorship> sponsorships = this.sponsorshipService.findSponsorshipsByProviderId();
	...
	public ModelAndView display(@RequestParam int sponsorshipId){
		ModelAndView res;
	...
	public ModelAndView create(){
		...
		res.addObject("positions",this.positionService.findPositionsFinalMode());
			...
			if (sponsorshipForm.getId() != 0
				...
				if (binding.hasErrors()) {
					...
					if (sponsorship.getId() == 0) {
						...
						res.addObject("positions",
								this.positionService.findPositionsFinalMode());
					} else {
						res = this.createEditModelAndView(sponsorshipForm,
								"sponsorship.commit.error.save");
					}
