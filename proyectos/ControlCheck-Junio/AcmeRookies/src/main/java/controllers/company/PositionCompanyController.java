...
public class PositionCompanyController extends AbstractController {
	...
	public ModelAndView create() {
		...
		problems = this.problemService.findProblemsByCompanyIdNoDraft(principal.getId());
	...
	public ModelAndView save(final @Valid PositionForm positionForm, final BindingResult binding) {
