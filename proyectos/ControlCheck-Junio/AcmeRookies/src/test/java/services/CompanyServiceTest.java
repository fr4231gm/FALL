...
public class CompanyServiceTest extends AbstractTest {
	...
	// Analysis of sentence coverage total: Covered 18.4% 81/440 total instructions
	...
	public void registerCompanyTestDriver() {
		...
		final Object testingData[][] = {
				...
				// TEST POSITIVO:
				{ "name", "surname", "comercialName", "A12345678", "http://www.google.es/photo.jpg", "123456789", "email@gmail.com", "address", "provide", "provide", 
		...
		for (int i = 0; i < testingData.length; i++) {
			...
			this.registerCompanyTemplate((String) testingData[i][0], (String) testingData[i][1], (String) testingData[i][2], (String) testingData[i][3], (String) testingData[i][4], (String) testingData[i][5], (String) testingData[i][6], (String) testingData[i][7],
	...
	protected void registerCompanyTemplate(final String name,
			final String surname, final String comercialName, final String vatNumber, final String photo,
		...
		try {
			final Company company = this.companyService.create(username, password);
	...
	public void listCompaniesByActorTestDriver() {
		...
		final Object testingData[][] = {
				...
				// TEST POSITIVO:
				{ "rookie1", null }, // Listar las positions
	...
	public void editCompanyTestDriver() {
		final Object testingData[][] = {
				...
				{ "name", "surname", "A12345678", "http://www.google.es/photo.jpg",
						...
						"rookie1", super.getEntityId("company1"),
