...
public class PositionServiceTest extends AbstractTest {
	...
	//Requierement: 7.4 An actor who is not authenticated as a rookie must be able to:
	...
	// In the case of negative tests, the business rule that is intended to be
	// broken:
	// Intentar crear una Position siendo un Rookie
	...
	public void CreateEditPositionTestDriver() {
		...
		final Object testingData[][] = {
				...
				{ "rookie1", "position", "description", deadline, "profile", "skills",
	...
	// Intentar borrar una Position como Rookie
	...
	public void deletePositionTestDriver() {
		...
		final Object testingData[][] = {
			...
			// TEST POSITIVO:
				...
				{ "company3", "position12", null },

				{ "company4", "position16", null },

				{ "company2", "position7", null },

				{ "company6", "position25", null },

				// TESTS NEGATIVOS:
				{ "provider1", "position1", IllegalArgumentException.class },

				{ "company1", "position12", IllegalArgumentException.class },

				{ "rookie1", "position1", IllegalArgumentException.class },

				{ "admin", "position1", IllegalArgumentException.class },

				{ "auditor3", "position1", IllegalArgumentException.class }
