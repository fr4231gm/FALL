...
public class CurriculaServiceTest extends AbstractTest {
	...
	//Intentar crear un Curricula cuyo personal Data no tenga descripci�n
	//Intentar crear un Curricula cuyo personal Data no tenga t�tulo
	...
	public void CreateEditCurriculaTestDriver() {
		...
		final Object testingData[][] = {
				...
				// TEST POSITIVO:
				{ "rookie3", "fullName1", "statement1", "662130562", "https://www.github.com", "https://www.linkedin.com", null },// Crear un Curricula
				...
				{ "rookie3", "fullName", "", "662130562", "https://www.github.com", "https://www.linkedin.com", ConstraintViolationException.class },		// Intentar 
																							//Crear un Curricula
				 																			// cuyo personal Data no tenga statement
				
				
				{ "rookie3", "", "statement", "662130562", "https://www.github.com", "https://www.linkedin.com", ConstraintViolationException.class } 	// Intentar 
																	 					  	//Crear un Curricula
																	 					  	// cuyo personal Data no tenga t�tulo
	...
	public void DeleteCurriculaTestDriver() {
		...
		// TEST POSITIVO:
		 {"rookie3", "curricula1", null},

		// TESTS NEGATIVOS:
		 {"rookie1", "curricula2", IllegalArgumentException.class}, // Intentar borrar un curricula que no es mio

		{"admin", "curricula1",IllegalArgumentException.class}, //Intentar borrar un curricula como admin
		 
		//{ "rookie3", "curricula7", DataIntegrityViolationException.class}, // Borrar un curricula copia
