...
public class InceptionRecordServiceTest extends AbstractTest{
	...
	//Intentar crear un inception record sin descripción
	...
	public void CreateEditInceptionTestDriver() {
		...
		final Object testingData[][] = {
				...
				//TESTS NEGATIVOS:
				{"brotherhood3","title", null, "",  ConstraintViolationException.class}, //Intentar crear un inception record sin descripción
