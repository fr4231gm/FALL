...
<div class="links">
	<acme:link code="brotherhood.parades" link="parade/list.do?brotherhoodId=${brotherhood.id}" />
	<br>
	...
	<acme:link code="brotherhood.members"
		link="member/list.do?brotherhoodId=${brotherhood.id}" />
	<br>

	<jstl:if test="${withHistory}">
		<acme:link code="brotherhood.history"
			link="history/display.do?historyId=${historyId}" />
	</jstl:if>
	<br>
</div>
