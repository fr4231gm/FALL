...
<form:form 
	...
	<acme:input code="brotherhood.name" path="name" placeholder="Marge"/>
	<br />

	<acme:input code="brotherhood.middle.name" path="middleName" placeholder="Lisa" />
	<br />

	<acme:input code="brotherhood.surname" path="surname" placeholder="Bouvier" />
	<br />

	<acme:input code="brotherhood.photo" path="photo" placeholder="https://www.google.es" />
	<br />

	<acme:input code="brotherhood.email" path="email" placeholder="rick@morty.es" />
	<br />
