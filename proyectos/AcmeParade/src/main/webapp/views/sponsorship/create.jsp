...
<form:form 
action = "sponsorship/sponsor/edit.do"
modelAttribute = "sponsorshipForm">
	...
	<form:select path="paradeId" >	
		<form:options items="${parades}" itemValue="id" itemLabel="title" />
	</form:select>
	<form:errors path="paradeId" cssClass="error" />
