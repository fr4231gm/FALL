...
<form:form modelAttribute="request">
	...
	<acme:input code="request.row" path="rowRequest" placeholder="2"/>
	<acme:input code="request.column" path="columnRequest" placeholder="2"/>
	<acme:textarea code="request.rejectReason" path="rejectReason" placeholder="you do not fit under the float"/>
