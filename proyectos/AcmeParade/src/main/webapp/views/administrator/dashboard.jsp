...
<canvas id="myChart" width="800" height="200"></canvas>
    ...
    <canvas id="myChart"></canvas>
  	...
  	<canvas id="chartContainer" width="800" height="200"></canvas>
	<br />
  ...
  <script>
    ...
    let massPopChart = new Chart(myChart, {
      ...
      data:{
        ...
        datasets:[{
          label:'Shouts',
          data:["${spammersRatio}","${10 - spammersRatio}"],
          backgroundColor:[
  ...
  var optionsOne = {
		...
		var ctxOne = document.getElementById('chartContainer').getContext('2d');
