...
<form:form 
	...
	<acme:input code="administrator.name" path="name" placeholder="José"/>
	<br />
	
	<acme:input code="administrator.middleName" path="middleName" placeholder="Luis"/>
	<br />

	<acme:input code="administrator.surname" path="surname" placeholder="González Gutiérrez"/>
	<br />
	...
	<acme:input code="administrator.address" path="address" placeholder="Calle Desengaóo,21"/>
	<br />
