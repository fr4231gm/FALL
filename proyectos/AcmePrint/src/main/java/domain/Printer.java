...
public class Printer extends DomainEntity {
	...
	public String toString() {
		return "Printer [ticker=" + ticker + ", make=" + make + ", model="
				+ model + ", description=" + description + ", datePurchase="
				+ datePurchase + ", warrantyDate=" + warrantyDate
				+ ", shoppingWebsite=" + shoppingWebsite + ", dimensionX="
				+ dimensionX + ", dimensionY=" + dimensionY + ", dimensionZ="
				+ dimensionZ + ", extruderDiameter=" + extruderDiameter
				+ ", nozzle=" + nozzle + ", materials=" + materials
				+ ", photo=" + photo + ", isActive=" + isActive + "]";
	}
