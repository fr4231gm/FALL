...
<form:form 
	...
	<acme:input code="designer.name" path="name" placeholder="José"/>
	<br />
	
	<acme:input code="designer.middleName" path="middleName" placeholder="Luis"/>
	<br />

	<acme:input code="designer.surname" path="surname" placeholder="González Gutiérrez"/>
	<br />
	...
	<acme:input code="designer.address" path="address" placeholder="Calle Desengaóo,21"/>
	<br />
