...
public class SocialProfileServiceTest extends AbstractTest {
	...
	//Requierement:
	// 19 An actor who is authenticated must be able to:
	// 6. Register several social profiles on his or her personal data.

	//In the case of negative tests, the business rule that is intended to be broken: 
	//Intentar crear socialProfile sin Nick

	// Analysis of sentence coverage total(): Covered 57% 45/79 total instructions
	...
	public void CreateEditSocialProfileTestDriver() {
		...
		final Object testingData[][] = {
			...
			//TEST POSITIVO: 
			{
				"designer1", "Nick", "https://www.google.es", "ENDESA", null
			}, //Crear un social profile

			//TESTS NEGATIVOS:
			{
				"designer1", "Nick", "", "ENDESA", ConstraintViolationException.class
			}, //Intenta crear social profile sin url
			{
				"designer1", "", "https://www.google.es", "ENDESA", ConstraintViolationException.class
	...
	// 19 An actor who is authenticated must be able to:
	// 6. delete a socialProfile

	//In the case of negative tests, the business rule that is intended to be broken: 
	//Intentar borrar un socialProfile que no es mio

	// Analysis of sentence coverage total(): Covered 45.6% 36/79 total instructions
	...
	public void DeleteSocialProfileTestDriver() {
		...
		final Object testingData[][] = {
			...
			//TESTS NEGATIVOS:
			{
				"designer2", "socialProfile3", IllegalArgumentException.class
			}, {
				"designer4", "socialProfile3", IllegalArgumentException.class
			},//Intentar borrar un socialProfile que no es mio
