...
public class MemberService {
	...
	public String deleteUserAccount() {
		...
		for (int i = 0; i < requestsToDelete.size(); i++) {
			exportedData = exportedData + "Request to:"
					+ requestsToDelete.get(i).getProcession().getTicker()
		...
		exportedData = exportedData + "Processions:"
				+ finderToDelete.getProcessions() + "Keyword: "
	...
	public String exportData() {
		...
		for (int i = 0; i < requests.size(); i++) {
			exportedData = exportedData + "Request to:"
					+ requests.get(i).getProcession().getTicker() + " Row:"
		...
		// FINDER
		exportedData = exportedData + "FINDER: ";
		exportedData = exportedData + "Processions:" + finder.getProcessions()
