	...
	<security:authorize access="hasRole('HACKER')">
		<jstl:if test="${permiso==true}">
				...
				<display:column>
					...
					<acme:link link="application/hacker/edit.do?applicationId=${row.id}"
				...
				<display:column>
					...
					<acme:link link="application/hacker/display.do?applicationId=${row.id}"
				...
				<display:column>
					...
					<acme:link link="application/hacker/submit.do?applicationId=${row.id}"
