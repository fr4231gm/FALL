...
<security:authorize access="hasRole('COMPANY')">
	...
	<jstl:if test="${permiso == true }">
		...
		<acme:input code="application.hacker"
	path="application.hacker.userAccount.username" readonly="true" />
...
<security:authorize access="hasRole('HACKER')">
	...
	<jstl:if test="${permiso == true }">
		...
		<acme:cancel url="application/hacker/list.do" code="application.goback" />
