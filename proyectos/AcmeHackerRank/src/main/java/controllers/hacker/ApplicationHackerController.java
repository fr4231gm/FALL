/*
 * ApplicationHackerController.java
 * 
...
public class ApplicationHackerController extends AbstractController {
	...
	public ModelAndView list() {
		...
		applications = this.applicationService.findApplicationsByHacker(principal.getId());
	...
	public ModelAndView edit(@RequestParam final int applicationId) {
		...
		try {
			...
			final Problem problem = application.getProblem();
			if (application.getHacker() == principal)
				permiso = true;
			Assert.isTrue(application.getHacker() == principal && application.getStatus().equals("PENDING"));
