...
public class CreditCardServiceTest extends AbstractTest {
	...
	// 1. Editar una tarjeta de credito de un hacker
	...
	public void editCreditCardTestDriver() {
		...
		final Object testingData[][] = {
			...
			// 2.TEST POSITIVO:
			{"Ramon","AMEX","4786864944775510",8,23,785,"hacker1", null},
			// 4.TEST NEGATIVO:
			{"Juan","VISA","4508789617365751",null,23,785,"company1", ConstraintViolationException.class},
			// 5.TEST NEGATIVO:
			{"Juan","VISA","4780000044775510",8,23,785,"hacker1", ConstraintViolationException.class},
		};
