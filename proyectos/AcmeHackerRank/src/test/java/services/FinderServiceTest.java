...
public class FinderServiceTest extends AbstractTest {
	...
	//Requierement: 17.2 An actor who is authenticated as a hacker must be able to:
	...
	//A company is trying to modify the finder of a hacker
	...
	//
	//only a hacker can edit his own finder
	@Test
	...
	protected void finderTemplate(final String username, final Class<?> expected) {
		...
		try {
			...
			final Finder f = this.hackerService.findByPrincipal().getFinder();
