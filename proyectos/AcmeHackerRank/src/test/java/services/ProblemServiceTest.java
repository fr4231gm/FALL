...
public class ProblemServiceTest extends AbstractTest {
	...
	// Templates---------------------------------------------------------------------------------
	private void listProblemByCompanyIdTemplate(String username, Class<?> expected) {
		Class<?> caught;
	...
	private void createEditProblemTemplate(String username, String title,
			String statement, String hint, String attachments, boolean isDraft,
			Class<?> expected) {
	...
	private void displayProblemTemplate(String problem, Class<?> expected) {
		Class<?> caught = null;
		try{
	...
	private void deleteProblemTemplate(String username, String problem,
			Class<?> expected) {
			Class<?> caught = null;
