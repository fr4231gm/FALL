...
<table>
	...
	<tr>
		...
		<!-- CONTROL CHECK -->
	<tr>
		<th style="font-size: 18px;  padding-top: 20px!important;"><spring:message code="administrator.dashboard.qulps.per.conference.stats" /></th>
		<td style="text-align: center; padding-top: 20px!important;"></td>
		<td style="text-align: center; padding-top: 20px!important;"></td>
		<td style="text-align: center; padding-top: 20px!important;"><jstl:out value="${QulpsPerConferenceStats[0]}" /></td>
		<td style="text-align: center; padding-top: 20px!important;"><jstl:out value="${QulpsPerConferenceStats[1]}" /></td>
	</tr>
</table>

<br>
<br>
<h3><spring:message code="administrator.dashboard.qulps.per.administrator.ratio" />: 
<jstl:out value="${QulpsPerAdministratorRatio}" /></h3><br>
<h3><spring:message code="administrator.dashboard.draft.qulps.ratio" />: 
<jstl:out value="${DraftQulpsRatio}" /></h3>
<br>
