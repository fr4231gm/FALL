...
<acme:link code="conference.porters"
	link="porter/list.do?conferenceId=${conference.id}" />
<br>
<br>
...
<jstl:if test="${not empty conference.comments}">
	...
	<display:table requestURI="conference/display.do"
		name="conference.comments" id="row" pagesize="5" class="displaytag">
